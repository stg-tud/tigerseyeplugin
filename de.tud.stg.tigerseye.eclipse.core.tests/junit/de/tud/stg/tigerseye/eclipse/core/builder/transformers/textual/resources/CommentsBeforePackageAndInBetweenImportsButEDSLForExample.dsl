 ...
 *  void fs()
 *  void ht()*/
//The algorithm should remove everything until it encounts something it doesn't know. So everything up to here. FINAL_ANCHOR
@EDSL({"anything"})
/*
 *  void lt(int)
 *  void pd()
...
import some.more.code.imports;

// I should get something for breakfest

import some.more.code.imports.without.semicolon

/**
 * The Concise Logo language adds shortened names for the operations
 * already supported by Simple Logo.
 */
//Including This comment Everything should be sanitized
