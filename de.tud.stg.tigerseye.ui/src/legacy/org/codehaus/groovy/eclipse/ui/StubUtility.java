...
public class StubUtility {
	...
	private static void setCompilationUnitVariables(CodeTemplateContext context, String fileName, String packageName, String projectName) {
		// Start editing by Fanshil & Melnyk at 04.02.09
		context.setVariable(CodeTemplateContextType.FILENAME, (fileName.endsWith(".dsl")?fileName: fileName+".dsl"));
		// End editing by Fanshil & Melnyk at 04.02.09
