 ...
 * 
 */
public abstract class MethodProductionElement implements
	MethodProductionConstants {
	...
	return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE)
		.append("capturedString", doGetCapturedString()).toString();
    }
	...
	if (doGetCapturedString == null)
	    throw new IllegalStateException(
		    "captured string has not yet been set");
	else
