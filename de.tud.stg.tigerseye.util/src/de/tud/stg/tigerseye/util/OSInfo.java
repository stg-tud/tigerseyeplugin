...
import static de.tud.stg.tigerseye.util.OSInfo.OSType.*;

/**
 * Copy of {@code sun.awt.OSInfo} which is not directly accessible. Licensed
 * under GPL 2.0.<br>
 * Added Mac handling.
 * <p>
 * A list of some OS related system properties to see what values can be
 * expected is found <a href="http://lopica.sourceforge.net/os.html">here</a>.
 * <p>
 * On <a href=
 * "http://stackoverflow.com/questions/1803075/crowdsourcing-a-complete-list-of-common-java-system-properties-and-known-values"
 * >Stackoverflow</a> someone "crowedsourced" a more complete list of all
...
public class OSInfo {
	...
	/*
	 * The map windowsVersionMap must contain all windows version constants
	 * except WINDOWS_UNKNOWN, and so the method getWindowsVersion() will return
	 * the constant for known OS. It allows compare objects by "==" instead of
	 * "equals".
	 */
